...
public class EgovDateUtil {
	...
	{
		return convertDate2(strSource, fromDateFormat, toDateFormat, strTimeZone, false);
	}
	 ...
	 * @return  소스 String의 날짜 포맷을 변경한 String
	 */
	public static String convertDate2(String strSource, String fromDateFormat, String toDateFormat, String strTimeZone, Boolean isEng) 
	{
		...
		try 
		{
			...
			if (Boolean.valueOf(isEng))
			{
				locale = Locale.ENGLISH;
			}
			
			simpledateformat = new SimpleDateFormat(_fromDateFormat, locale);
			...
			simpledateformat = new SimpleDateFormat(_toDateFormat, locale);
		} 
	...
	* @return 변환된 문자열
	...
	{
		List<ZoneId> timeZones = new ArrayList<ZoneId>();
