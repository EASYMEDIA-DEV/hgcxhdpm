...
public enum CompanyPayType implements DatabaseCodeCommonType {
    BEFORE("선불", "B", null, null),
    AFTER("후불", "A", null, null),
    ;
    ...
    @JsonCreator
    public static CompanyPayType fromCode(Object value) {
