package com.easymedia.common.utility;
...
public class COWebUtil {
	...
	public static String clearXSSMinimum(String value)
	{
		...
		returnValue = returnValue.replaceAll("~!singlecomma!~", "\'");
		returnValue = returnValue.replaceAll("~!doublecomma!~", "\"");
